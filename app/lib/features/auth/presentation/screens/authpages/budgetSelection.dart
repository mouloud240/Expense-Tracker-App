        ...
        DropdownMenuEntry(value: "EUR", label: "Euro",
            ...
            style: ButtonStyle(
              ...
              shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(16.r))),
                        ...
                        onPressed: (){
                        BlocProvider.of<UserBloc>(context).add(SetBudgetEvent(Money(money.toDouble() ,_selectedCurrency)));
                        }, child: Text("Continue",style: TextStyle(color: Colors.white,fontWeight:FontWeight.w600,fontSize:18.sp ),)),
                        const Spacer()
                      ], 
                    ),
                  ),
